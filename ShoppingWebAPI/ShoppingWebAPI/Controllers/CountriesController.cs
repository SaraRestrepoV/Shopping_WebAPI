...
namespace ShoppingWebAPI.Controllers
{
    ...
    public class CountriesController : ControllerBase
    {
        ...
        [HttpGet, ActionName("Get")]
        [Route("Get/{id}")]
        public async Task<ActionResult<Country>> GetCountriesById(Guid? id)
        {
            var country = await _context.Countries.FirstOrDefaultAsync(c => c.Id == id); // Select * From Countries where...
